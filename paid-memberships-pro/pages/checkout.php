                ...
                <div id="pmpro_user_fields" class="pmpro_checkout">
                    ...
                    <div class="pmpro_checkout-fields user_info full_width">
                        ...
                        <div class="pmpro_checkout-field pmpro_checkout-field-password">
                            <label for="password"><?php _e('Password', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        if($pmpro_checkout_confirm_password) { ?>
                            <div class="pmpro_checkout-field pmpro_checkout-field-password2">
                                <label for="password2"><?php _e('Confirm Password', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <div class="pmpro_checkout-field pmpro_checkout-field-bemail">
                            <label for="bemail"><?php _e('E-mail Address', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        if($pmpro_checkout_confirm_email) { ?>
                            <div class="pmpro_checkout-field pmpro_checkout-field-bconfirmemail">
                                <label for="bconfirmemail"><?php _e('Confirm E-mail Address', 'paid-memberships-pro' );?><span>*</span></label>
                    ...
                    <div class="pmpro_checkout-fields">
                        <div class="half_width">
                            <div class="pmpro_checkout-field pmpro_checkout-field-bfirstname">
                                <label for="bfirstname"><?php _e('First Name', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <div class="half_width right">
                            <div class="pmpro_checkout-field pmpro_checkout-field-blastname">
                                <label for="blastname"><?php _e('Last Name', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <div class="pmpro_checkout-field pmpro_checkout-field-baddress1">
                            <label for="baddress1"><?php _e('Address 1', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        if($longform_address) { ?>
                            <div class="half_width">
                                <div class="pmpro_checkout-field pmpro_checkout-field-bcity">
                                    <label for="bcity"><?php _e('City', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <div class="half_width right">
                                <div class="pmpro_checkout-field pmpro_checkout-field-bstate">
                                    <label for="bstate"><?php _e('State', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <div class="half_width">
                                <div class="pmpro_checkout-field pmpro_checkout-field-bzipcode">
                                    <label for="bzipcode"><?php _e('Postal Code', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <?php } else { ?>
                            <div class="pmpro_checkout-field pmpro_checkout-field-bcity_state_zip">
                                <label for="bcity_state_zip"><?php _e('City, State Zip', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        if($show_country) { ?>
                            <div class="half_width right">
                                <div class="pmpro_checkout-field pmpro_checkout-field-bcountry">
                                    <label for="bcountry"><?php _e('Country', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <div class="pmpro_checkout-field pmpro_checkout-field-bphone">
                            <label for="bphone"><?php _e('Phone', 'paid-memberships-pro' );?><span>*</span></label>
                        ...
                        <?php if($skip_account_fields) { ?>
                            ...
                            if($pmpro_checkout_confirm_email) { ?>
                                <div class="pmpro_checkout-field pmpro_checkout-field-bconfirmemail">
                                    <label for="bconfirmemail"><?php _e('Confirm E-mail', 'paid-memberships-pro' );?><span>*</span></label>
                                    <input id="bconfirmemail" name="bconfirmemail" type="<?php echo ($pmpro_email_field_type ? 'email' : 'text'); ?>" class="input <?php echo pmpro_getClassForField("bconfirmemail");?>" size="30" value="<?php echo esc_attr($bconfirmemail); ?>" />
                                </div> <!-- end pmpro_checkout-field-bconfirmemail -->
                            <?php } else { ?>
                                <input type="hidden" name="bconfirmemail_copy" value="1" />
                    ...
                    <div class="pmpro_checkout-fields-display-seal">
                        ...
                        <div class="pmpro_checkout-fields">
                            ...
                            if($pmpro_include_cardtype_field) { ?>
                                <div class="pmpro_checkout-field pmpro_payment-card-type half_width">
                                    <label for="CardType"><?php _e('Card Type', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <?php } ?>
                            <div class="pmpro_checkout-field pmpro_payment-account-number half_width right">
                                <label for="AccountNumber"><?php _e('Card Number', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <div class="pmpro_checkout-field pmpro_payment-expiration">
                                <label for="ExpirationMonth"><?php _e('Expiration Date', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            if($pmpro_show_cvv) { ?>
                                <div class="pmpro_checkout-field pmpro_payment-cvv half_width">
                                    <label for="CVV"><?php _e('Security Code (CVC)', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <?php } ?>
                            <?php if($pmpro_show_discount_code) { ?>
                                <div class="pmpro_checkout-field pmpro_payment-discount-code half_width">
                                    <label for="discount_code"><?php _e('Discount Code', 'paid-memberships-pro' );?><span>*</span></label>
                            ...
                            <?php } ?>
                            <?php if(!empty($sslseal)) { ?>
                            <div class="pmpro_checkout-fields-rightcol pmpro_sslseal half_width right"><?php echo stripslashes($sslseal); ?></div>
                        </div> <!-- end pmpro_checkout-fields -->
                ...
                <?php } else { ?>
                    ...
                    if($pmpro_checkout_default_submit_button)
                    {
                        ...
                        <span id="pmpro_submit_span">
                            ...
                            <input type="submit" class="pmpro_btn pmpro_btn-submit-checkout button red" value="<?php if($pmpro_requirebilling) { _e('Start Your Free Trial Today!', 'paid-memberships-pro' ); } else { _e('Submit and Confirm', 'paid-memberships-pro' );}?>" />
                        </span>
