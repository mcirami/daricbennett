...
?>
	...
	<div class="form_wrapper full_width">
							...
							<tr id="other_discount_code_tr" style="display: none;">
								<td>
									<div>
										...
										<input class="button yellow" type="button" name="other_discount_code_button" id="other_discount_code_button" value="<?php _e('Apply', 'pmpro');?>" />
									</div>
								</td>
							</tr>
							<?php } ?>
			...
			<div class="full_width" id="pmpro_level-<?php echo $pmpro_level->id; ?>">
			...
			<form id="pmpro_form" class="pmpro_form checkout_page" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
				...
				<!--<div id="checkout_red_border_wrap" class="red_border_wrap full_width">-->
					...
					<tbody>
						<tr>
							<td>
								<div>
									<label for="username"><?php _e('Username', 'pmpro');?><span>*</span></label>
								...
								<div>
									<label for="password"><?php _e('Password', 'pmpro');?><span>*</span></label>
								...
								<?php
									...
									?>
									<div>
										<label for="password2"><?php _e('Confirm Password', 'pmpro');?><span>*</span></label>
								...
								<div>
									<label for="bemail"><?php _e('E-mail Address', 'pmpro');?><span>*</span></label>
								...
								<?php
									...
									?>
									<div>
										<label for="bconfirmemail"><?php _e('Confirm E-mail Address', 'pmpro');?><span>*</span></label>
					...
					<tr>
						<td>
							<div class="half_width">
								<label for="bfirstname"><?php _e('First Name', 'pmpro');?><span>*</span></label>
							...
							<div class="half_width right">
								<label for="blastname"><?php _e('Last Name', 'pmpro');?><span>*</span></label>
							...
							<div>
								<label for="baddress1"><?php _e('Address 1', 'pmpro');?><span>*</span></label>
							...
							?>
								<div class="half_width">
									<label for="bcity"><?php _e('City', 'pmpro');?><span>*</span></label>
								...
								<div class="half_width right">
									<label for="bstate"><?php _e('State', 'pmpro');?><span>*</span></label>
								...
								<div class="half_width">
									<label for="bzipcode"><?php _e('Postal Code', 'pmpro');?><span>*</span></label>
							...
							<?php
								...
								<div class="half_width">
									...
									<?php
										...
										{
										?>
										<input id="bstate" name="bstate" type="text" class="input <?php echo pmpro_getClassForField("bstate");?> half_width right" size="2" value="<?php echo esc_attr($bstate)?>" />
										<?php
										}
									?>
							...
							?>
							<div class="half_width right">
								<label for="bcountry"><?php _e('Country', 'pmpro');?><span>*</span></label>
							...
							?>
							<div>
								<label for="bphone"><?php _e('Phone', 'pmpro');?><span>*</span></label>
						...
						<tr valign="top">
							<td>
								...
								<?php
									...
									{
									?>
									<div class="pmpro_payment-card-type half_width">
										<label for="CardType"><?php _e('Card Type', 'pmpro');?><span>*</span></label>
								...
								<div class="pmpro_payment-account-number half_width right">
									<label for="AccountNumber"><?php _e('Card Number', 'pmpro');?><span>*</span></label>
								...
								<div class="pmpro_payment-expiration">
									<label for="ExpirationMonth"><?php _e('Expiration Date', 'pmpro');?><span>*</span></label>
									<select id="ExpirationMonth" name="ExpirationMonth" class=" <?php echo pmpro_getClassForField("ExpirationMonth");?> half_width">
									...
									<select id="ExpirationYear" name="ExpirationYear" class=" <?php echo pmpro_getClassForField("ExpirationYear");?> half_width right">
										<?php
								...
								<?php
									...
									if($pmpro_show_cvv) { ?>
								<div class="pmpro_payment-cvv half_width">
									<label for="CVV"><?php _e('CVV', 'pmpro');?><span>*</span></label>
							...
							<!--	<?php if($pmpro_show_discount_code) { ?>
								<div class="pmpro_payment-discount-code">
									...
									<input class="button yellow" type="button" id="discount_code_button" name="discount_code_button" value="<?php _e('Apply', 'pmpro');?>" />
					...
					<?php } else { ?>
						...
						<?php
							...
							<span id="pmpro_submit_span">
								...
								<input class="button red" type="submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php if($pmpro_requirebilling) { if (pmpro_hasMembershipLevel()){_e('Checkout Now', 'pmpro');} else {_e('Start Your Free Trial Today!', 'pmpro');} } else { _e('Submit and Confirm', 'pmpro');}?> " />
                                <p>By clicking "Start Your Free Trial Today!" you agree to our <a target="_blank" href="<?php echo $webroot; ?>privacy">Privacy Policy</a>, <a target="_blank" href="<?php echo $webroot?>terms-of-use">Terms of Service</a> and <a target="_blank" href="<?php echo $webroot?>terms-of-use/#refund">Refund Policy</a>.
</p>
							</span>
							<?php
							}
	...
	<div id="ssl">
		<iframe width="100%" height="100%" scrolling='yes' src="https://ssl.comodo.com/pdf/comodo_EV_SSL.pdf?track=2302"></iframe>
	</div>
