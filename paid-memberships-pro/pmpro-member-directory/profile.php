...
function pmpromd_profile_shortcode($atts, $content=null, $code="")
{
	...
	?>
    <div class="container">
        <div class="directory_profile_wrap full_width">
	<?php if(!empty($show_search)) { ?>
        <form action="<?php echo $directory_url; ?>" method="post" role="search" class="pmpro_member_directory_search search-form">
            <label>
                ...
                <input type="search" class="search-field" placeholder="<?php _e('Enter Username To Search','pmpromd'); ?>" name="ps" value="<?php if(!empty($_REQUEST['ps'])) echo esc_attr($_REQUEST['ps']);?>" title="<?php _e('Search Members','pmpromd'); ?>" />
	...
	<?php
		if(!empty($pu))
		{
			...
			<div id="pmpro_member_profile-<?php echo $pu->ID; ?>" class="pmpro_member_profile">
                ...
                <div class="column">
                    <p><span>Username: </span><?php echo $pu->user_nicename; ?></p>
                ...
                <div class="column">
                    ...
                    <?php if(!empty($show_bio) && !empty($pu->description) ) { ?>
                        <p class="pmpro_member_directory_bio">
                            <span><?php _e('About me', 'wp'); ?></span>
                            <?php echo $pu->description; ?>
                        </p>
                    <?php } ?>
                    <?php if(!empty($show_bio) && !empty($pu->bass_guitars) ) { ?>
                        <p class="pmpro_member_bass_guitars">
                            <span><?php _e('Bass Guitars', 'wp'); ?>:</span>
                            <?php echo $pu->bass_guitars; ?>
                        </p>
                    <?php } ?>
                    <?php if(!empty($show_bio) && !empty($pu->bass_amps) ) { ?>
                        <p class="pmpro_member_bass_amps">
                            <span><?php _e('Bass Amps', 'wp'); ?>:</span>
                            <?php echo $pu->bass_amps; ?>
                        </p>
                    <?php } ?>
                    <?php if(!empty($show_email)) { ?>
                        <p class="pmpro_member_directory_email">
                            <span><?php _e('Email Address', 'pmpromd'); ?></span>
                            <?php echo $pu->user_email; ?>
                        </p>
                    <?php } ?>
                    <?php if(!empty($show_startdate)) { ?>
                        <p class="pmpro_member_directory_date">
                            <span><?php _e('Start Date', 'pmpromd'); ?></span>
                    ...
                    <?php if(!empty($show_billing) && !empty($pu->pmpro_baddress1)) { ?>
                        <p class="pmpro_member_directory_baddress">
                            <span><?php _e('Address', 'pmpromd'); ?></span>
