	...
	<div id="bbp-single-user-details">
				...
				<ul>
					...
					<li class="<?php if ( bbp_is_single_user_topics() ) :?>current<?php endif; ?>">
						<span class='bbp-user-topics-created-link'>
							<a href="<?php bbp_user_topics_created_url(); ?>" title="<?php printf( esc_attr__( "%s's Topics Started", 'bbpress' ), bbp_get_displayed_user_field( 'display_name' ) ); ?>"> <?php _e( 'Topics', 'bbpress' ); ?></a>
						</span>
					</li>
	
					<li class="<?php if ( bbp_is_single_user_replies() ) :?>current<?php endif; ?>">
						<span class='bbp-user-replies-created-link'>
							<a href="<?php bbp_user_replies_created_url(); ?>" title="<?php printf( esc_attr__( "%s's Replies Created", 'bbpress' ), bbp_get_displayed_user_field( 'display_name' ) ); ?>"><?php _e( 'Replies', 'bbpress' );  ?></a>
						</span>
					</li>
		...
		<div id="bbp-user-body" class="<?php if ( bbp_is_single_user_profile() ) { echo "profile_body"; } if ($isMailbox !== false) { echo " mailbox"; } ?>">
            ...
            <?php if (!$isCurrentUser) : ?>
                ...
                <a class="button red" href="/my-inbox/?fepaction=newmessage&fep_to=<?php bbp_displayed_user_field( 'display_name' ); ?>">Send Message</a>
